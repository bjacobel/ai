...
public class ValueIterationMDP {
    ...
    public static void main (String[] args) {
        ...
        System.out.println("You specified the following options:\ndiscountFactor: \t" + discountFactor + "\nmaxStateUtilityError: \t" + maxStateUtilityError + "\nkeyLossProbability: \t" + keyLossProbability + "\npositiveTerminalReward: " + positiveTerminalReward + "\nnegativeTerminalReward: " + negativeTerminalReward + "\nstepCost: \t\t" + stepCost + "\nsolutionTechnique: \t" + solutionTechnique + "\n");
