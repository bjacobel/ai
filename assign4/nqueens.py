...
def run(numQueens, maxSteps, interactive, variant, variant2):
    ...
    for i in range(0, numQueens):
        queens.append(Queen(i, numQueens, variant2))
    ...
    for i in range(divisor):
        ...
        for i in range(maxSteps / divisor):
            totalConflicts = 0
            for queen in queens:
...
def main():
    ...
    run(numQueens, maxSteps, interactive, variant, variant2)
